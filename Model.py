...
pool=Pooling(3,1)
lrn=LRN()
cnn2=CNN_layer(1,5,50)
cnn3=CNN_layer(1,3,40)
cnn4=CNN_layer(1,3,40)
cnn5=CNN_layer(1,3,25)
fn1=Full_connection(50)
fn2=Full_connection(50)
pool1=Pooling(3,1)
pool2=Pooling(3,1)
pool3=Pooling(3,1)
pool4=Pooling(3,1)
...
for number in range(25):
 for a in range(19):
    ...
    fn1.momentum()
    dx_f1=pool5.g_mean(dx_f1.reshape((r.shape)))
    dcn5=cnn5.g_cnn(lrn.g(dReLU(dx_f1,l5)))
    cnn5.momentum()
    dcn5 = pool4.g_mean(dcn5)
    dcn4 = cnn4.g_cnn(lrn.g(dReLU(dcn5,l4)))
    dcn4=pool3.g_mean(dcn4)
    cnn4.momentum()
    dcn3 = cnn3.g_cnn(lrn.g(dReLU(dcn4,l3)))
    dcn3 = pool2.g_mean(dcn3)
    cnn3.momentum()
    dcn2 = cnn2.g_cnn(lrn.g(dReLU(dcn3,l2)))
    cnn2.momentum()
    dcn2 = pool1.g_mean(dcn2)
    dcn1 = cnn1.g_cnn(lrn.g(dReLU(dcn2,l1)))
    cnn1.momentum()
